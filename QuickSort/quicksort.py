...
Quick sort
@author: Michael Liao
http://www.liaoxuefeng.com/category/0013738748415562fee26e070fa4664ad926c8e30146c67000/5
...
稳定排序是指如果排序前有两个相同的数，比如对[a=10, b=10, c=2]排序，a和b相等，
排序前a在b的前面，稳定排序后结果为[c, a, b]，a仍然在b的前面，
而不稳定排序则不保证相等的两个数位置不会交换，排序结果可能变为[c, b, a]。
'''